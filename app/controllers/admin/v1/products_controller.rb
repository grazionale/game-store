module Admin::V1
  class ProductsController < ApiController
    ...
    # usamos os bang nos métodos destroy! tanto para @product quanto para seu productable. 
    # Desta forma, qualquer erro na remoção poderemos recuperar o erro e renderizar
    def destroy
